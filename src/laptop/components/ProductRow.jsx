...
const ProductRow = ({ title, type, allproducts }) => {
  ...
  return (
    <div className="pr-laptop-product-cardproduct-row">
      <h4 className="pr-laptop-product-cardproduct-row-title">{title}</h4>

      <div className="pr-laptop-product-cardscroll-btns">
        <button className="pr-laptop-product-cardscroll-btn left" onClick={() => handleScroll("left")}>
          <FaChevronLeft />
        </button>
        <button className="pr-laptop-product-cardscroll-btn right" onClick={() => handleScroll("right")}>
          <FaChevronRight />
        </button>
      </div>

      <div className="pr-laptop-product-cardproduct-scroll-container" ref={scrollContainerRef}>
        {products.map((product) => (
          <div key={product._id} className="pr-laptop-product-cardproduct-card">
            <div className="pr-laptop-product-cardproduct-card-upper">
              <div className="laptop-product-image-wrapper" onClick={() => handleProductClick(product._id)}>
                <img src={product.image} alt={product.name} className="pr-laptop-product-cardproduct-image" />
                <button
            ...
            <div className="laptop-product-info">
              ...
              <p className="laptop-product-price" onClick={() => handleProductClick(product._id)}>Price: ₹{product.varieties[0].price}</p>
