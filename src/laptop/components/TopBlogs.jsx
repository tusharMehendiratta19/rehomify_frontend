    ...
    <div className="topblogs">
      ...
      <div className="seller-image-grid">
        <div className="seller-image-card seller-image-card-1" key={1}>
          ...
          <button className="seller-image-btn seller-image-btn-1">Smart Buys for Students</button>
        </div>
        <div className="seller-image-card seller-image-card-2" key={2}>
          ...
          <button className="seller-image-btn seller-image-btn-2">Elegant Interiors Collection</button>
        </div>
        <div className="seller-image-card seller-image-card-3" key={3}>
          ...
          <button className="seller-image-btn seller-image-btn-3">Gear Up for Exam Season</button>
        </div>
        <div className="seller-image-card seller-image-card-4" key={4}>
          ...
          <button className="seller-image-btn seller-image-btn-4">Cozy Reading Corners</button>
        </div>
        <div className="seller-image-card seller-image-card-5" key={5}>
          ...
          <button className="seller-image-btn seller-image-btn-5">Style Meets Comfort</button>
        </div>
        <div className="seller-image-card seller-image-card-6" key={6}>
          ...
          <button className="seller-image-btn seller-image-btn-6">Budget Picks for You</button>
        </div>
        <div className="seller-image-card seller-image-card-7" key={7}>
          ...
          <button className="seller-image-btn seller-image-btn-7">Dream Bedroom Ideas</button>
        </div>
