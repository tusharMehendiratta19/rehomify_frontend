                    ...
                    {wishlist != "" ? wishlist.map((item) => (
                        <div className="laptop-wishlist-card" key={item.id}>
                            ...
                            <img
                                src={item.imageUrl}
                                alt={item.name}
                                className="laptop-wishlist-image"
                                onClick={() => handleProductClick(item.id)}
                            />
                            <div className="laptop-wishlist-details">
                                <h4
                                    className="laptop-wishlist-name"
                                    onClick={() => handleProductClick(item.id)}
                                >
                                    {item.name}
                                </h4>
                                <p className="laptop-wishlist-category">{item.category}</p>
                                <p className="laptop-wishlist-description">{item.description}</p>
                                <p className="laptop-wishlist-price">₹{item.price}</p>

                                <div className="laptop-wishlist-buttons">
                        ...
                        <div className='emptyWishlist'>No Products Found 😔</div>
                    }
                </div>

                {snackbarOpen && (
                    <div className="laptop-snackbar">Product removed from wishlist</div>
                )}
            </div>
