...
const AddProductForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Append varieties
        formData.varieties.forEach((v, i) => {
            data.append(`varieties[${i}][name]`, v.name);
            data.append(`varieties[${i}][price]`, v.price);
        });

        // Store price as first variety's price
        if (formData.varieties.length > 0) {
            data.append('price', formData.varieties[0].price);
        }

        // Append other fields
        const { varieties, varietyCount, ...rest } = formData;
    ...
    return (
        <div className="add-product-container">
            ...
            <form onSubmit={handleSubmit} className="add-product-form" encType="multipart/form-data">
                ...
                <input type="text" name="colorCode" list="colorCode" placeholder="Color Code" value={formData.colorCode} onChange={handleChange} />
