...
const offersData = [
  ...
  },
  {
    ...
    code: "ICICI5",
    image: "offer2.jpeg",
    offerHead: "5% Cashback"
  },
  {
    id: 3,
    type: "Bank Offer",
    description: "No Cost EMI on SBI Cards",
    code: "SBIEMI",
    image: "offer3.jpeg",
    offerHead: "No Cost EMI"
  },
  {
    id: 4,
    type: "Wallet Offer",
        ...
        <div className="offers-row">
          {offersData.map((offer) => (
            <div className="offer-card" key={offer.id}>
              ...
              <div className="offer-discount">{offer.offerHead}</div>
